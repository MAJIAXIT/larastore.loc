                ...
                @foreach ($purchases as $purchase)
                    @php
                        ...
                        $productCount = DB::table('purchases')
                            ->where([['user_id', '=', $user->id], ['product_id', '=', $purchase->product_id]])
                            ->get()
                            ->count();
                    @endphp
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Куплено: {{ $purchase->added_at }}
                                    <p class="card-text text-end"><small
                                            class="text-muted">${{ $product->price * $productCount }}</small>
                                        <span class="badge rounded-pill bg-dark">{{ $productCount }}</span>
                                    </p>
                                    </p>
                                </div>
                            </div>
