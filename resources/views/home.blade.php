...
@section('content')
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 g-3">
        ...
        <div class="col">
            <div type="button" onclick="window.location.href='/productsByCategory/1'" style="border-radius: 25px;"
                class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden shadow-sm">
                <div class="my-3 p-3">
                    <h2 class="display-5">Sweet iPhones</h2>
                    <p class="lead">Click to watch catalogue</p>
                </div>
                <div class="mx-auto" style="width: 80%; height: 400px; border-radius: 21px 21px 0 0;">
        ...
        <div class="col">
            <div type="button" onclick="window.location.href='/productsByCategory/2'" style="border-radius: 25px;"
                class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden shadow-sm">
                <div class="my-3 py-3">
        ...
        <div class="col">
            <div type="button" onclick="window.location.href='/productsByCategory/3'" style="border-radius: 25px;"
                class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden shadow-sm">
                <div class="my-3 py-3">
        ...
        <div class="col">
            <div type="button" onclick="window.location.href='/productsByCategory/4'" style="border-radius: 25px;"
                class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden shadow-sm">
                <div class="my-3 p-3">
